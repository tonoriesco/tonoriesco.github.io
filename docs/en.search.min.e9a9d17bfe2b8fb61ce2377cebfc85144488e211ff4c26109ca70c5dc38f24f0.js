...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3d9411ca2c68829638a81862955d9db07f95c1ccfbec8500e0439051b030029e.js',function(){input.required=false;search();});}
